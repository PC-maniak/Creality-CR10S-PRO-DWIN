...
#define DWIN_M117 0x2117
#define SpeedFan 0x1100
#define Volume 0x1088
#define SettingPage 0x103E
#define ReturnBack 0x1040
#define Printfile 0x1002
#define Ajust 0x1004
#define Feedrate 0x1006
#define FlowRate 0x1406
#define Zoffset 0x1026
#define TempControl 0x1030
#define ManualSetTemp 0x1032
#define Bedlevel 0x1044
#define No_Filement 0x105E
#define PwrOffNoF 0x105F
#define AdvancedMenu 0x1900
/************struct**************/
...
class RTSSHOW {
  public:
    ...
    void RTS_SndDataL(long unsigned int , int);
...
//    ,Bedlevel,Autohome,XYZEaxis=XYZEaxis_Value,Filement=Filement_Value,LanguageChoice=Language_Value,PwrOffNoF,Volume,Filename=Filename_Value};
//
...
//#else
  ...
  enum PROC_COM {PrintChoice=PrintChoice_Value,Setting=Setting_Value
    ,Autohome,XYZEaxis=XYZEaxis_Value,Filement=Filement_Value,LanguageChoice=Language_Value,Filename=Filename_Value};

  const unsigned long Addrbuf[] = {0x1002, 0x1004,0x1006, 0x1008, 0x1009, 0x100A, 0x100C,  0x1026, 0x1030, 0x1032, 0x1034, 0x103A,
                0x103E, 0x1040, 0x1044, 0x1046, 0x1048, 0x104A, 0x104C, 0x1054, 0x1056, 0x1058,
                0x105C, 0x105E, 0x105F, 0x1088, 0x1100,0x1900, 0};
                // 0x1100 SpeedFan
//#endif
...
//extern char PrinterStatusKey[2] = {0};
