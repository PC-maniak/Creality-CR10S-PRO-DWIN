...
extern const char *injected_commands_P = NULL;
#else
            ...
            if(PoweroffContinue)
              {
                ...
                enqueue_and_echo_commands_P((PSTR("G28 X0 Y0")));
			       ...
			       #endif
        			if(PrinterStatusKey[1] == 3) // FIX ME 1 ?
        			{
...
inline void gcode_M18_M84() {
  ...
  ////////////////// CREALITY_DWIN  @PC-maniak //////////////////
  ///////////////////////////////////////////////////////////////
  #if ENABLED(CREALITY_DWIN_FAST) // AUTO FINISH! The 3D printing results
...
inline void gcode_M117()
{
  ...
  {
    rtscheck.RTS_SndData("", DWIN_M117);
    rtscheck.RTS_SndData(parser.string_arg, DWIN_M117);
